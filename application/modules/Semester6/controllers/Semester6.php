...
class Semester6 extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->model('M_semester6');
    ...
    function index()
    {
        $data['semester6'] = $this->M_semester6->get_data('semester')->result();
        $data['course'] = $this->M_semester6->get('course')->result();
        $data['score'] = $this->M_semester6->get('score')->result();
        $data['judul'] = 'Semester Page';
        $this->load->view('Templates/Header', $data);
        $this->load->view('Templates/Topbar');
        $this->load->view('Templates/Sidebar');
        $this->load->view('V_semester6');
    ...
    {
        $where = array('id' => $id);
        $this->M_semester6->delete($where, 'semester');
        $this->session->set_flashdata('message', '
            <div class="alert alert-success alert-dismissible fade show" role="alert">
    ...
    function download()
    {
        $data = array(
            ...
            'unduh' => $this->M_semester6->get_data()->result()
        );
    ...
    function downloadAll()
    {
        $data = array(
            'title' => 'Tabel Semester',
            'unduh' => $this->M_semester6->get_all()->result()
        );
        $this->load->view('V_excel', $data);
    }
}
