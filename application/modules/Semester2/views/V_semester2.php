                            ...
                            <tbody>
                                ...
                                foreach ($semester2 as $se) : ?>
                                    <tr>
                                        ...
                                        <td><?= $se->semester; ?></td>
                                        <td align="center">
                                            <button type="button" class="btn btn-sm btn-warning shadow mb-4" data-toggle="modal" data-target="#editSemester2Modal<?= $se->id; ?>">
                                                <i class="fa fa-wrench"></i> Edit
                                            </button>
                                            <button type="button" class="btn btn-sm btn-danger shadow mb-4" data-toggle="modal" data-target="#deleteSemester2Modal<?= $se->id; ?>">
